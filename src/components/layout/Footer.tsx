    ...
    <footer className="border-t border-border bg-muted/30">
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-sm">
              Software Engineer specializing in AI/ML and full-stack development. Helping aspiring MS/PhD students
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="https://github.com/NajmiHassan"
                target="_blank"
              ...
              <a
                href="mailto:najmihassan.dev@gmail.com"
                className="w-10 h-10 rounded-lg bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors"
              >
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground">Built with passion for excellence</p>
        </div>
      </div>
    </footer>
  );
